...
import type { WeatherContentProps, WeatherIconNames, WeatherIconProps } from './weatherAboutType';

export const weatherIconsList: Record<WeatherIconNames, WeatherIconProps> = {
  sun: {
    id: 'sun',
    iconSvg: (
      <svg
...
export const weatherContent: WeatherContentProps = {
  en: {
    title: 'Currently in',
    dayTime: 'Day',
    nightTime: 'Night',
...
export const mapSvg: React.ReactElement<SVGProps<SVGSVGElement>> = (
  ...
  >
    ...
    <circle
      ...
      cy="675"
      r="20"
      /* className="fill-btn-primary-hover-light dark:fill-btn-primary-hover-dark" */
    ...
    <circle
      ...
      stroke-width="5"
      fill="none"
      /* className="stroke-btn-primary-hover-light dark:stroke-btn-primary-hover-dark" */
