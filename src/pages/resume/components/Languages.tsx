...
const Languages = forwardRef<HTMLElement, LanguagesProps>(({ visible }, ref) => {
        ...
        {languagesList.map((lang) => {
          ...
          return (
            <li key={lang.id} className="grid h-28 w-28 place-items-center">
              <h4 className="transition-theme font-bold">{lang.name}</h4>
              <span className="transition-theme col-start-1 col-end-2 row-start-1 row-end-2 font-bold">
                {lang.levelEu}
              </span>
              <svg className="col-start-1 col-end-2 row-start-1 row-end-2">
                ...
                <circle
                  ...
                  className="stroke-accent-light dark:stroke-accent-dark transition-theme translate-50/100 overflow-visible fill-none stroke-4 transition-[stroke-dashoffset] duration-2000 ease-in-out"
                />
              </svg>
            </li>
          );
